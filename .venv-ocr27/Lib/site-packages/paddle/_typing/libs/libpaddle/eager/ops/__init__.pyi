...
def embedding_grad_add_to(token_indices: paddle.Tensor, main_grad_: paddle.Tensor, out_grad: paddle.Tensor) -> paddle.Tensor:
    ...
    """
def embedding_grad_add_to_(token_indices: paddle.Tensor, main_grad_: paddle.Tensor, out_grad: paddle.Tensor) -> paddle.Tensor:
    """
...
def flashmask_attention_grad(*args, **kwargs):
    ...
    """
def flashmask_attention_v2(q: paddle.Tensor, k: paddle.Tensor, v: paddle.Tensor, startend_row_indices: paddle.Tensor, softmax_scale: float, is_causal: bool) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
...
def logspace(start: paddle.Tensor, stop: paddle.Tensor, num: paddle.Tensor, base: paddle.Tensor, dtype: paddle._typing.DTypeLike, place: paddle._typing.PlaceLike = {}) -> paddle.Tensor:
    ...
    """
def logsumexp(x: paddle.Tensor, axis: list[int] = [], keepdim: bool = False, reduce_all: bool = False) -> paddle.Tensor:
    """
...
def silu(x: paddle.Tensor) -> paddle.Tensor:
    ...
    """
def silu_(x: paddle.Tensor) -> paddle.Tensor:
    """
...
def tril(x: paddle.Tensor, diagonal: int = 0) -> paddle.Tensor:
    ...
    """
def tril_(x: paddle.Tensor, diagonal: int = 0) -> paddle.Tensor:
    """
...
def triu(x: paddle.Tensor, diagonal: int = 0) -> paddle.Tensor:
    ...
    """
def triu_(x: paddle.Tensor, diagonal: int = 0) -> paddle.Tensor:
    """
